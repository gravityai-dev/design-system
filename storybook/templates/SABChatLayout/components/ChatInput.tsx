...
export default function ChatInput({ placeholder = "Ask a question...", onSend, disabled = false }: ChatInputProps) {
    ...
    <div className={styles.container}>
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.inputWrapper}>
          ...
          {/* Send button */}
          <button type="submit" disabled={disabled || !value.trim()} className={styles.submitButton}>
